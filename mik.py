...
courseid = "29"  # Exchange with valid id.
# Get all sections of the course.
sec = LocalGetSections(courseid)

# Output readable JSON, but print only summary
print(json.dumps(sec.getsections[9]['summary'], indent=4, sort_keys=True))
...
summary = '<a href="https://mikhail-cct.github.io/ca3-test/wk1/">Week 9: Introduction</a><br>'
